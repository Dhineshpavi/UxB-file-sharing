...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7108769924:AAGGaHh6V6hCbmeHV6WnchZPiXAyutY11qc")
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002008853384"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "577a8a08363b6aaa1d1dbdf18ea1b473ca2ca695")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "false")
TUT_VID = os.environ.get("TUT_VID","https://t.me/How_downlode_dpbots")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @Dp_botz</b>")
